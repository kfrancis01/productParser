...
function createPopupWithBorder(message, backgroundColor, borderColor) {
  ...
  iconImg.src = "icon/CCC.png"; // Set the path to your icon image
  ...
  //   if (document.body.textContent.includes("cruelty-free" || "vegan") ) {
  //     popup2.style.border = `2px solid green`;
  //   } else {
  //     popup2.style.border = `2px solid red`;
  //   }
  // });
...
if (badIngredientsFound.length > 0) {
...
} else if (midIngredientsFound.length > 0 && badIngredientsFound.length == 0) {
  // Create a popup with a list of bad ingredients found
  createPopupWithBorder(
  ...
  goodIngredientsFound.length > 0 &&
  badIngredientsFound.length == 0 &&
  midIngredientsFound.length == 0
) {
  // Create a popup with a list of bad ingredients found
  createPopupWithBorder(
  ...
  createPopupWithBorder("No ingredients found.", "gray", "gray");
}
